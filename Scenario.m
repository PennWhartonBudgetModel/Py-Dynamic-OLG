...
classdef Scenario
    ...
    properties (GetAccess = public, SetAccess = immutable)
        ...
        % Tax parameters
        TaxCalculator_BaseBrackets;
        
        % Social Security parameters
        OASIcalculator_TaxRate;
        OASIcalculator_TaxMax;
        OASIcalculator_DonutHole;
        OASIcalculator_COLA;
        OASIcalculator_PIA;
        OASIcalculator_NRA;
        OASIcalculator_CreditEarningsAboveTaxMax;
        OASIcalculator_FirstYear;
        OASIcalculator_GradualChange;
    ...
    properties (Constant, Access = private)
        ...
        def_params = struct(...
            ...
            'amnesty'                                   , 0.0               , ...
            'deportation'                               , 0.0               , ...
            'TaxCalculator_BaseBrackets'                , 'CurrentPolicy'   , ...
            'OASIcalculator_TaxRate'                    , 0                 , ...
            'OASIcalculator_TaxMax'                     , 0                 , ...
            'OASIcalculator_DonutHole'                  , 0                 , ...
            'OASIcalculator_COLA'                       , 0                 , ...
            'OASIcalculator_PIA'                        , 0                 , ...
            'OASIcalculator_NRA'                        , 0                 , ...
            'OASIcalculator_CreditEarningsAboveTaxMax'  , 0                 , ...
            'OASIcalculator_FirstYear'                  , -1                , ...
            'OASIcalculator_GradualChange'              , -1                ...
        );
