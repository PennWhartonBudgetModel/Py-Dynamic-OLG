...
classdef Scenario
    ...
    methods (Static)
        ...
        function [scenarios] = fetch_batch( batchID )
            ...
            % Load the TaxPlanMap
            taxplanMap = readtable(fullfile(    Environment.getCurrent().taxplan_param    ...
                                            ,   'TaxPlanMap.csv'                      ...
                                            ));
            ...
            for i = 1:size(dataset)
                ...
                if( canAdd )
                    ...
                    ind = find( (   strcmp(dataset(i).BaseBrackets, taxplanMap.BaseBrackets)    ...
                                 &  (dataset(i).HasBuffetRule == taxplanMap.HasBuffetRule)      ...
                                 &  (dataset(i).HasAGISurcharge_5m == taxplanMap.HasAGISurcharge_5m)      ...
                                 &  (dataset(i).HasCapitalExclusion == taxplanMap.HasCapitalExclusion)      ...
                                 &  (dataset(i).HasDoubleStandardDeduction == taxplanMap.HasDoubleStandardDeduction)      ...
                                 &  (dataset(i).HasLimitDeductions == taxplanMap.HasLimitDeductions)      ...
                                 &  (dataset(i).NoAMT == taxplanMap.NoAMT)      ...
                                 &  (dataset(i).HasExpandChildCredit == taxplanMap.HasExpandChildCredit)      ...
                                 &  (dataset(i).NoACAIncomeTax == taxplanMap.NoACAIncomeTax)      ...
                                 ));
