    ...
    methods (Access=public)
        ...
        function [this] = Scenario(params)
            ...
            this.basedeftag = strjoin({...
                ...
                sprintf('%u'    , this.IsLowReturn          ), ...
                sprintf('%u'    , this.TransitionFirstYear  ), ...
                sprintf('%u'    , this.TransitionLastYear   ), ...
            ...
            if this.isCurrentPolicy()
                ...
                this.counterdeftag = strjoin({...
                    sprintf('%.2f'  , this.ExpenditureShift                 ), ...
                    sprintf('%.1f'  , this.legal_scale                      ), ...
                    sprintf('%.1f'  , this.prem_legal                       ), ...
                    sprintf('%.1f'  , this.amnesty                          ), ...
                    sprintf('%.1f'  , this.deportation                      ), ...
                    sprintf('%s'    , this.BaseBrackets                     ), ...
                    sprintf('%u'    , this.HasBuffetRule                    ), ...
                    sprintf('%u'    , this.HasDoubleStandardDeduction       ), ...
                    sprintf('%u'    , this.HasLimitDeductions               ), ...
                    sprintf('%u'    , this.HasExpandChildCredit             ), ...
                    sprintf('%u'    , this.NoACAIncomeTax                   ), ...
                    sprintf('%.2f'  , this.CorporateTaxRate                 ), ...
                    sprintf('%u'    , this.HasSpecialPassThroughRate        ), ...
                    sprintf('%u'    , this.HasImmediateExpensing            ), ...
                    sprintf('%u'    , this.HasRepealCorporateExpensing   )}, '_');
            end
