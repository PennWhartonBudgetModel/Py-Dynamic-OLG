...
methods (Static)
    ...
    function [save_dir] = solve(scenario, callertag, resolve) %#ok<*FXUP>
        ...
        while (~isConverged && iter < itermax)
            ...
            if isinitial
                ...
                switch economy
                    ...
                    case 'open'
                        ...
                        klRatio = theCorporation.new_calculateKLRatio( steadyCapitalAfterTaxReturn      ...
            ...
            if( strcmp( scenario.economy, 'steady' ) )
                theCorporation.setInterestRate( max(Market.equityFundDividends, 0.001) );
            end 
            
            % Compute prices and price indices
            Market.wages               = theCorporation.wageRequired()';
