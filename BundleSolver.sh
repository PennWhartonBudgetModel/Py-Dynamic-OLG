...
matlab -nodesktop -nosplash -r "PathFinder.setToProductionMode(), MexBuilder.all(), BundleSolver.generateScenarioSet('$1')"
...
qsub -N currentpolicy \
     ...
     -b y 'matlab -nojvm -nosplash -r "PathFinder.setToProductionMode(), BundleSolver.solveCurrentPolicy(${SGE_TASK_ID})"'
...
qsub -N counterfactual -hold_jid currentpolicy \
     ...
     -b y 'matlab -nojvm -nosplash -r "PathFinder.setToProductionMode(), BundleSolver.solveCounterfactual(${SGE_TASK_ID})"'
...
qsub -N generate -hold_jid counterfactual \
     ...
     -b y 'matlab -nodesktop -nosplash -r "PathFinder.setToProductionMode(), BundleSolver.checkTerminations(), BundleSolver.generateDataSeries('"'"$1"'"')"'
