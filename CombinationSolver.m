...
methods (Static)
    ...
    function [] = generateSeries()
        ...
        ,   'RevenuesIndividualIncomeTax'       , struct('var_name', 'pits'         , 'static_source', 'projections')    ...
        ,   'RevenuesCorporateIncomeTax'        , struct('var_name', 'corpTaxs'     , 'static_source', 'projections')    ...
