...
methods (Static)
    ...
    function [scenario] = convertOutputScenario(s)
        ...
        parameters = struct( ...
            ...
            'IsLowReturn'           , s.IsLowReturn             , ...
            'CapitalAdjustmentCost' , s.CapitalAdjustmentCost   , ...
            'AllowBusinessDebt'     , s.AllowBusinessDebt       , ...
            'TransitionFirstYear'   , 2018                      , ...
            'OpennessPath'          , 'closed'                  , ...
            'TransitionLastYear'    , 2040                      , ...
            'ClosureYear'           , 2040                        ...
        );
    ...
    function [currentpolicys, counterfactuals] = generateScenarios(output_parameters, input_parameters)
        ...
        output_parameters0.UseDynamicBaseline       = {false, true};
        output_parameters0.LaborElasticity          = {0.5};
        output_parameters0.IsLowReturn              = {false};
        output_parameters0.AllowBusinessDebt        = {true};
        output_parameters0.CapitalAdjustmentCost    = {0.0};
    ...
    function [] = generateSeries()
        ...
        ,   'SS_TaxablePayroll'                     , struct('var_name', 'laborIncomeSubjectToSocialSecuritys', 'static_source', 'oasicalculator') ...
        ,   'SS_TaxesOnBenefits'                    , struct('var_name', 'averageEffectivePITRatesProductSocialSecurityBenefits', 'static_source', 'oasicalculator') ...
        ,   'SS_PayrollTaxes'                       , struct('var_name', 'ssts'                               , 'static_source', 'oasicalculator') ...
        );
