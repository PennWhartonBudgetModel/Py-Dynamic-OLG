...
d_steady = load(fullfile(steady_dir  , 'dynamics.mat'), ... 
            'debts', 'revs', 'outs', 'caps', 'labs', 'labeffs', 'labincs', 'assets', 'pops', 'cons', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs' );
d_steady.caps_foreign = 0;
d_open   = load(fullfile(open_dir  , 'dynamics.mat'), ... 
            'debts', 'revs', 'outs', 'caps', 'caps_foreign', 'labs', 'labeffs', 'labincs', 'assets', 'pops', 'cons', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs' );
...
os = {'debts', 'revs', 'outs', 'caps', 'caps_foreign', 'labs', 'labeffs', 'labincs', 'assets', 'cons', 'pops', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs'};
for o = os
...
f = @( d, s, m, mb, b ) table(yearsv', m.MPKs', m.debtrates', m.equityFundDividends', m.equityFundPrices', m.wages', m.rhos', ...
                  d.outs', d.caps', d.labs', d.labeffs', (d.labeffs ./ d.pops)', d.labincs', d.cons', d.assets', d.debts', d.revs', d.investment', d.corpTaxs', ...
                  s.outs', s.caps', s.labs', s.labeffs', (s.labeffs ./ s.pops)', s.labincs', s.cons', s.assets', s.debts', s.revs', s.investment', s.corpTaxs', ...
