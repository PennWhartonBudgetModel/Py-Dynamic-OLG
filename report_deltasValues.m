...
header      = {'year', 'MPK', 'gov_interest_rate', 'equityFundDividends', 'equityFundPrices', 'wages', 'K_L_ratio', ...
               'output_d', 'capital_d', 'labor_d', 'labor_efficient_d', 'labor_efficient_by_pop_d', 'labincs_d', 'consumption_d', 'assets_d', 'debt_d', 'revenues_d', 'investment_d', 'corpTaxs_d', ...
               'output_s', 'capital_s', 'labor_s', 'labor_efficient_s', 'labor_efficient_by_pop_s', 'labincs_s', 'consumption_s', 'assets_s', 'debt_s', 'revenues_s', 'investment_s', 'corpTaxs_s', ...
...
f = @( d, s, m, mb, b ) table(yearsv', m.MPKs', m.debtrates', m.equityFundDividends', m.equityFundPrices', m.wages', m.rhos', ...
                  d.outs', d.caps', d.labs', d.labeffs', (d.labeffs ./ d.pops)', d.labincs', d.cons', d.assets_1', d.debts', d.revs', d.investment', d.corpTaxs', ...
                  s.outs', s.caps', s.labs', s.labeffs', (s.labeffs ./ s.pops)', s.labincs', s.cons', s.assets_1', s.debts', s.revs', s.investment', s.corpTaxs', ...
