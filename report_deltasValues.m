...
d_steady = load(fullfile(steady_dir  , 'dynamics.mat'), ... 
            'debts', 'revs', 'outs', 'caps', 'labs', 'labeffs', 'labincs', 'assets_1', 'pops', 'cons', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs' );
d_steady.caps_foreign = 0;
d_open   = load(fullfile(open_dir  , 'dynamics.mat'), ... 
            'debts', 'revs', 'outs', 'caps', 'caps_foreign', 'labs', 'labeffs', 'labincs', 'assets_1', 'pops', 'cons', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs' );
...
m_steady  = load(fullfile(steady_dir , 'market.mat' ), 'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1');
m_open    = load(fullfile(open_dir   , 'market.mat' ), 'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1');
mb_open   = load(fullfile(bopen_dir  , 'market.mat' ), 'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1');
m_closed  = load(fullfile(closed_dir , 'market.mat' ), 'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1');
mb_closed = load(fullfile(bclosed_dir, 'market.mat' ), 'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1');

% Include steady state year in all series
include_ss = @(x, xss) [xss x];
os = {'debts', 'revs', 'outs', 'caps', 'caps_foreign', 'labs', 'labeffs', 'labincs', 'assets_1', 'cons', 'pops', 'cits', 'pits', 'ssts', 'bens', 'investment', 'corpTaxs'};
for o = os
...
os = {'MPKs', 'wages', 'rhos', 'debtrates', 'equityFundDividends', 'equityFundPrices', 'capshares_1'};
for o = os
...
header      = {'year', 'MPK', 'gov_interest_rate', 'equityFundDividends', 'equityFundPrices', 'wages', 'K_L_ratio', ...
               'output_d', 'capital_d', 'foreignCapital_d', 'labor_d', 'labor_efficient_d', 'labor_efficient_by_pop_d', 'labincs_d', 'consumption_d', 'assets_d', 'debt_d', 'revenues_d', 'investment_d', 'corpTaxs_d', ...
               'output_s', 'capital_s', 'foreignCapital_s', 'labor_s', 'labor_efficient_s', 'labor_efficient_by_pop_s', 'labincs_s', 'consumption_s', 'assets_s', 'debt_s', 'revenues_s', 'investment_s', 'corpTaxs_s', ...
               'MPK_b', 'wages_b', 'output_b', 'capital_b', 'labor_efficient_b', 'labincs_b', 'revenues_b', 'investment_b', 'corpTaxs_b'};

f = @( d, s, m, mb, b ) table(yearsv', m.MPKs', m.debtrates', m.equityFundDividends', m.equityFundPrices', m.wages', m.rhos', ...
                  d.outs', d.caps', d.caps_foreign', d.labs', d.labeffs', (d.labeffs ./ d.pops)', d.labincs', d.cons', d.assets_1', d.debts', d.revs', d.investment', d.corpTaxs', ...
                  s.outs', s.caps', s.caps_foreign', s.labs', s.labeffs', (s.labeffs ./ s.pops)', s.labincs', s.cons', s.assets_1', s.debts', s.revs', s.investment', s.corpTaxs', ...
                  mb.MPKs', mb.wages', b.outs', b.caps', b.labeffs', b.labincs', b.revs', b.investment', b.corpTaxs', ...
...
f = @( m, mb, d, s ) table(yearsv', ...
                    m.MPKs', m.debtrates', m.equityFundDividends', m.equityFundPrices', m.wages', m.rhos', ...
                   (d.outs ./ s.outs)', (d.caps ./ s.caps)', (d.caps_foreign ./ s.caps_foreign)', (d.labs ./ s.labs)', ...
                   (d.labeffs ./ s.labeffs)', (d.assets_1 ./ s.assets_1)', (d.cons ./ s.cons)', (d.investment ./ s.investment)', ...
                   ...
                   (d.totinc ./ s.totinc)', (d.totincwss ./ s.totincwss)', ...
                    m.totrates', mb.MPKs', mb.debtrates', mb.equityFundDividends', mb.equityFundPrices', mb.wages', mb.rhos', mb.totrates', ...
                   'VariableNames', header);
...
f = @( d, s, m ) table(yearsv', m.MPKs', m.debtrates', m.equityFundDividends', m.equityFundPrices', m.wages', m.rhos', ...
                      (d.outs ./ s.outs)', (d.debts ./ s.debts)', (d.revs ./ s.revs)', ...
                      (d.caps ./ s.caps)', (d.labs ./ s.labs)', (d.labeffs ./ s.labeffs)', ...
                      (d.assets_1 ./ s.assets_1)', ((d.assets_1./d.pops) ./ (s.assets_1./s.pops))', ...
                      'VariableNames', header);
