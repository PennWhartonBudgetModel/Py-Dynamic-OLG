...
function [save_dir] = solve_closed(deep_params, plan, gcut, showmore, this_uniquetag)
...
if ~strcmp(plan, 'base')
    ...
    if ~exist(base_aggregates, 'file')
        ...
        uniquetag = sprintf('_closed_plan=%s_gcut=%+0.2f', plan, gcut);
        solve_closed(deep_params, 'base', +0.00, showmore, uniquetag);
...
generate_static_aggregates(deep_params, plan, gcut, this_uniquetag);
