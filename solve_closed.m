...
%     cap_total = ([kpr_ss, kpr_total(1:end-1)] - debt_total)/q_tobin;
...
fcaptax_total          = domestic_fcaptax_total + foreign_fcaptax_total; %#ok<NASGU>

labinc_total = elab_total .* wages;
kinc_total   = (rate_caps - 1) .* (kpr_total - debt_total);
...
save(fullfile(save_dir, 'aggregates.mat'), ...
     ...
     'Gtilde', 'Ttilde', 'Gtilde_openbase', 'GEXP_cut')
