...
import inputReaderModule as InputReader
import scenarioModule as Scenario
...
class OutputWriter:
    ...
    dynamic_outvars = {
        ...
        'corpTaxs'          : 'CorpTax'                 , 
        'corpDebts'         : 'CorpDebt'                , 
        'corpTaxbase'       : 'CorpTaxbase'             , 
        'corpCits'          : 'CorpCits'                , 
        'corpDebtInterest'  : 'CorpDebtInterest'        , 
        'corpDepreciation'  : 'CorpDepreciation'        , 
        'corpExpensing'     : 'CorpExpensing'           , 
        'corpDebtTaxBenefit': 'CorpDebtTaxBenefit'      , 
        'corpDebtCost'      : 'CorpDebtCost'            , 
      'corpDividendsForeign': 'CorpDividendsForeign'    , 
    'corpForeignWithholding': 'CorpForeignWithholding'  , 
        'passDividends'     : 'PassThroughDividends'    , 
        'passDebts'         : 'PassThroughDebts'        , 
        'passTaxableIncome' : 'PassThroughTaxableIncome', 
        'passDebtInterest'  : 'PassThroughDebtInterest' , 
        'passDepreciation'  : 'PassThroughDepreciation' , 
        'passExpensing'     : 'PassThroughExpensing'    , 
        'passDebtTaxBenefit': 'PassDebtTaxBenefit'      , 
      'passDividendsForeign': 'PasDividendsForeign'     , 
    ...
    def writeScenarios(scenarios):
        ...
        for i in range(firstScenario,numScenarios + 1):
            ...
            # Verify that scenario fields match the map scenarios
            if np.sort(scenarioParams.keys()) != np.sort(mapScenarios.keys()):
                raise Exception(   'OuputWriter: Mapfile Scenario columns do not match Worklist Scenario columns.')
