...
properties (Constant, Access = private)
    ...
    inputversions = struct( ...
        'Production'    , struct( ...
            ...
            'TaxCalculator' , struct('taxplan'      , '2017-12-05-SenCMA_2'                 ), ...
            'SocialSecurity', struct('policy'       , '2017-12-05-Test'                     ), ...
            'DynamicModel'  , struct('calibration'  , '2017-10-20-05-56-efraim-f0a4c45'     )  ...
        ), ...
        'Testing'       , struct( ...
            'CBO'           , struct('cbo'          , '2017-09-14'                          ), ...
            'Microsim'      , struct('microsim'     , '2017-10-23'                          ), ...
            'TaxCalculator' , struct('taxplan'      , '2017-11-30-Test'                     ), ...
            'SocialSecurity', struct('policy'       , '2017-12-05-Test'                     ), ...
            'DynamicModel'  , struct('calibration'  , '2017-10-20-05-56-efraim-f0a4c45'     )  ...
        )  ...
        );
...
methods (Static, Access = public)
    ...
    % Get SocialSecurity input directory
    function [ssinputdir] = getSocialSecurityInputDir()
        ssinputdir = PathFinder.getInputDir('SocialSecurity', 'policy');
    end
