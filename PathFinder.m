...
properties (Constant, Access = private)
    ...
    inputversions = struct( ...
        'Production'    , struct( ...
            'CBO'           , struct('debt'         , '2018-01-24'                          ), ...
            'Defaults'      , struct('macro'        , '2018-01-04'                          ), ...
            'Microsim'      , struct('microsim'     , '2018-01-26'                          ), ...
            'TaxCalculator' , struct('taxplan'      , '2018-01-30-timeVariantTests'         ), ...
        ...
        'Testing'       , struct( ...
            ...
            'Defaults'      , struct('macro'        , '2018-01-04'                          ), ...
            'Microsim'      , struct('microsim'     , '2018-01-26'                          ), ...
            'TaxCalculator' , struct('taxplan'      , '2018-01-31-Test'                     ), ...
            'SocialSecurity', struct('taxpolicy'    , '2017-12-14-Test'                     , ...
                                     'nrapolicy'    , '2017-12-14-Test'                     , ...
                                     'benpolicy'    , '2017-12-14-Test'                       ...
                              ), ...
...
methods (Static, Access = public)
    ...
    function [cboinputdir] = getCboInputDir()
        cboinputdir = PathFinder.getInputDir('CBO', 'debt');
    end
