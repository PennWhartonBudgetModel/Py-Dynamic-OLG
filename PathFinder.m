...
properties (Constant, Access = private)
    ...
    inputversions = struct( ...
        'Production'    , struct( ...
            ...
            'Projections'   , struct('projections'      , '2018-06-20-13-57-arnon-a930d29'       ), ...    
            'Openness'      , struct('openness'         , '2018-06-20-13-57-arnon-a930d29'       ), ...    
            'TaxCalculator' , struct('taxcalculator'    , '2018-08-01-11-48-14-jricco-f323dc6'   ), ...
            'OASIcalculator', struct('oasicalculator'   , '2018-07-13-12-52-59-njanetos-453df3d' ), ...
            'DynamicModel'  , struct('calibration'      , '2017-10-20-05-56-efraim-f0a4c45'      )  ...
        ), ...
        'Testing'       , struct( ...
            'Microsim'      , struct('microsim'         , '2018-01-26'                           ), ...
            'Projections'   , struct('projections'      , '2018-08-03-1pm-efraim-test'           ), ...    
            'Openness'      , struct('openness'         , '2018-08-03-1pm-efraim-test'           ), ...    
...
methods (Static, Access = public)
    ...
    function [inputdir] = getOpennessInputDir()         , inputdir = PathFinder.getInputDir('Openness'          , 'openness'        ); end
