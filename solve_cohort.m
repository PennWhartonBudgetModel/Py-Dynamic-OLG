        ...
        for is = 1:ns
            ...
            if (age > T_work)
                ...
                [resources, inc, pit, sst, cit] = calculate_resources( ...
                    labinc, ssinc, ...
                    sv(is), ...
                    portfolio_passshare, portfolio_equityshare, portfolio_bondshare, ...
                    passfund_price, equityfund_price, bondfund_price, ...
                    passfund_dividendrate, equityfund_dividendrate, bondfund_dividendrate, ...
...
function [resources, pit_inc, pit, sst, cit] ...
    ...
    % Calculate wealth in equity, pass-throughs, and g'vt bonds
    passvalue       = savings * portfolio_passshare     * passfund_price;
    equityvalue     = savings * portfolio_equityshare   * equityfund_price;
    bondvalue       = savings * portfolio_bondshare     * bondfund_price;
    
    passdividend    = passfund_dividendrate   * passvalue;
    ...
    % Calculate available resources
    resources = equityvalue + bondvalue + passvalue ...
                + equitydividend + bonddividend + passdividend ...
                + labinc + ssinc ...
                - (pit + sst + cit) ...
                + beq;
