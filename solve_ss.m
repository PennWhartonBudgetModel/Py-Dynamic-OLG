...
while true
    ...
    [opt, dist, kpr_total, DD, elab_total, beq_total, wage, cap_share, debt_share, rate_cap, rate_gov, rate_tot, cap_inc] ...
     ...
       = solve_and_generate(...
           rho, kpr, DEBTss, beq, ...
...
save(fullfile(save_dir, 'solution.mat'), ...
     ...
     'cap_share', 'debt_share', 'rate_cap', 'rate_gov', 'rate_tot', 'cap_inc')
...
function [opt, dist, kpr_total, DD, elab_total, beq_total, wage, cap_share, debt_share, rate_cap, rate_gov, rate_tot, cap_inc] ...
          ...
            = solve_and_generate(...
                rho, kpr, DD, beq, ...
                T, Tr, Tss, bgrid, kgrid, ndem, nb, nk, nz, ...
    ...
    [V, Vss, kopt, koptss, labopt, bopt, ...
     ...
     ...
       = solve_dynamic_optimization_mex(...
           ...
           wage*ones(1,Tss), cap_share*ones(1,Tss), debt_share*ones(1,Tss), rate_cap*ones(1,Tss), rate_gov*ones(1,Tss), rate_tot*ones(1,Tss), cap_inc*ones(1,Tss), zeros(1,Tss), q_tobin, q_tobin, Vbeq, ...
