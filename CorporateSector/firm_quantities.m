function [Available_assets, output_total, capital_total, labor_total, eq_total, inv_total, adjcost_total] = firm_quantities(prices)
...
[capital_total, labor_total, eq_total, inv_total, adjcost_total, V_total, output_total, dist] = solve_firm_optimization_mex(prices, s_firm.firm_params); %#ok<ASGLU>
