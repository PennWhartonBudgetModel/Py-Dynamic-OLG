...
[capital_total, labor_total, eq_total, inv_total, adjcost_total, V_total, output_total, tax_total, dist] = solve_firm_optimization(prices, s_tax.taxes, s.firm_params);
