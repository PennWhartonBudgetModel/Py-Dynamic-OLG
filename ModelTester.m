...
properties (Constant)
    ...
    test_params = struct(...
        'economy'           , 'steady'              , ...
        'beta'              , 1.025100000000000     , ...
        'gamma'             , 0.680000000000000     , ...
        'sigma'             , 1.500000000000000     , ...
        'bequest_phi_1'     , 0                     , ...
        'depreciation'      , 0.096                 , ...
        'modelunit_dollar'  , 4.450000000000000e-05 , ...
        'corporate_tax_rate', 0.2                   );

    d_low_test_params = struct(...
        'economy'           , 'steady'              , ...
        'beta'              , 0.994000000000000     , ...
        'gamma'             , 0.720000000000000     , ...
        'sigma'             , 1.140000000000000     , ...
        'bequest_phi_1'     , 0                     , ...
        'depreciation'      , 0.056                 , ...
        'modelunit_dollar'  , 4.378174881178362e-05 , ...
        'corporate_tax_rate', 0.2                   );
