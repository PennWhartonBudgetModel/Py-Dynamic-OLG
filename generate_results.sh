...
qsub -N baseline -t 1-16 -q short.q \
		 ...
		 -b y 'matlab -nodesktop -nosplash -r "pool = parpool(12), solve_closed(inddeep_to_params(${SGE_TASK_ID}), '\''base'\'', +0.00, false), delete(pool)"'
...
qsub -N package -hold_jid counterfactual -q short.q \
     ...
     -b y 'matlab -nodesktop -nosplash -r "pool = parpool(24), check_closed_convergence, generate_static_aggregates_closed, package_results, delete(pool)"'